...
/** \def STEPS_PER_M
	...
	for threaded rods, this is
		(steps motor per turn =200 ) / (1.25mm = pitch of the thread) * 1000
	...
	AKA 7x7  mill is (200 steps/rev)/(1.25mm per rev) * 1000
*/
#define	STEPS_PER_M_X					160000
#define	STEPS_PER_M_Y					160000
#define	STEPS_PER_M_Z					160000
...
/*
	...
	NOPE this is for AKA's custom, shitty temporary setup
*/
...
#define	X_DIR_PIN   					DIO27//AIO1
#define	X_MIN_PIN   					DIO53
...
#define	Y_STEP_PIN  					DIO24//AIO6
#define	Y_DIR_PIN   					DIO25//AIO7
...
#define	Z_STEP_PIN  					DIO22//DIO46
#define	Z_DIR_PIN   					DIO23//DIO48
#define	Z_INVERT_DIR
